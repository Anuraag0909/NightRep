...
const _descriptor_1 = new __compactRuntime.CompactTypeVector(1, _descriptor_0);
...
export class Contract {
  ...
  _test_0(a_0) { const h_0 = this._persistentHash_0([a_0]); return []; }
}
  ...
  test: (...args_0) => {
    ...
    if (!(a_0.buffer instanceof ArrayBuffer && a_0.BYTES_PER_ELEMENT === 1 && a_0.length === 32)) {
      __compactRuntime.typeError('test',
                                 'argument 1',
                                 'test.compact line 1 char 65',
                                 'Bytes<32>',
                                 a_0)
    }
    return _dummyContract._test_0(a_0);
  }
};
